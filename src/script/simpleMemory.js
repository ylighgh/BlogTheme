...
if (initCheck()) {
    ...
    window.cnblogsConfigDefault = {
        ...
        homeTopImg: [
            "https://cdn.jsdelivr.net/gh/ylighgh/Blog-Theme@master/img/webp/home_top_bg.webp"
        ],
        homeBannerText: "",
        homeBannerTextType: "jinrishici",
        essayTopImg: [
            "https://cdn.jsdelivr.net/gh/ylighgh/Blog-Theme@master/img/webp/nothome_top_bg.webp"
        ],
